...
<head>
    ...
    <style>
        ...
        select, input[type="number"] { padding: 8px; border: 1px solid #d1d5db; border-radius: 6px; font-family: 'Inter', sans-serif; }
...
<body>
   <div class="sidebar">
        <h2>SMARTCAMPUS</h2>
        <a href="enseignant_dashboard.php" class="active">Gestion des Notes</a>
        <a href="enseignant_absences.php">Faire l'Appel</a>
    ...
    <div class="content">
        ...
        <?php if(isset($_GET['statut']) && $_GET['statut'] == 'success'): ?>
            <div class="success-msg">✅ La note a été enregistrée avec succès !</div>
        <?php endif; ?>
        <div class="card">
            <table>
                <thead>
                    <tr><th>Étudiant</th><th>Cours</th><th>Type</th><th>Note (/20)</th><th>Coef.</th><th>Action</th></tr>
                </thead>
                <tbody>
                    <?php foreach($etudiants as $etudiant): ?>
                    <tr>
                        <form action="saisir_notes.php" method="POST">
                            ...
                            <td><input type="number" name="valeur" step="0.01" min="0" max="20" required placeholder="14.5" style="width: 70px;"></td>
                            <td><input type="number" name="coefficient" min="1" max="5" value="1" required style="width: 50px;"></td>
